...
export const heroSlides = [
    {
        ...
        subtxt:'우리는 움직일 때 새로운 생각을 할 수 있습니다. 움직임은 곧 새로운 생각, 영감, 그리고 진보입니다.',
        ctaTxt: "자세히보기",
        ctaHref: "/",
        image:{
    ...
    {
        id:'hero-2',
        title:'차량 그 이상의 플랫폼 - PBV',
        subtxt:'PV5 WAV와 오픈베드, 패신저 모델은 교통약자를 포함한 모든 이들에게 이동의 자유를 보장하고, 진정한 상생 실현을 위한 혁신적 솔루션',
        ctaTxt: "자세히보기",
        ctaHref: "/",
        image:{
